...
----------------------------------------*/
class ecobit_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('ecobit_instagram_photo',esc_html__('[ Ecobit ] Intagram Photo','ecobit'),array(
			'description' => esc_html__('Ecobit Instagram Photo Widget','ecobit'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'ecobit');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'ecobit'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'ecobit'); ?></label>
...
if(!function_exists('ecobit_instagram_widgets')):
	function ecobit_instagram_widgets(){
		register_widget('ecobit_instagram_photo');
	}
	add_action('widgets_init','ecobit_instagram_widgets');
endif;
