...
// enqueue css
function ecobit_common_custom_css(){
    
    wp_enqueue_style( 'ecobit-common', get_template_directory_uri().'/assets/css/dynamic.css' );
		$header_bg         		  = esc_url( get_header_image() );
		$header_bg_img 			  = !empty( $header_bg ) ? 'background-image: url('.esc_url( $header_bg ).')' : '';

		$themeColor     		  = ecobit_opt( 'ecobit_theme_color' ) != '#ff4800' ? ecobit_opt('ecobit_theme_color') : '';

		$buttonBorderColor     	  = ecobit_opt( 'ecobit_button_border_color' );
		$hoverColor     	  	  = ecobit_opt( 'ecobit_hover_color');

		$headerTop_bg     		  = ecobit_opt( 'ecobit_top_header_bg_color' );
		$headerTop_col     		  = ecobit_opt( 'ecobit_top_header_color' );

		$headerBg          		  = ecobit_opt( 'ecobit_header_bg_color') != '#562fc7' ?  ecobit_opt( 'ecobit_header_bg_color') : '';
		$dropdownBg          	  = ecobit_opt( 'ecobit_header_bg_color') != '#562fc7' ?  ecobit_opt( 'ecobit_header_bg_color') : $themeColor;
		$menuColor          	  = ecobit_opt( 'ecobit_header_menu_color' );
		$menuHoverColor           = ecobit_opt( 'ecobit_header_menu_hover_color' ) != '#ff4800' ? ecobit_opt('ecobit_header_menu_hover_color') : $themeColor;
		$dropMenuColor            = ecobit_opt( 'ecobit_header_drop_menu_color' );
		$dropMenuHovColor         = ecobit_opt( 'ecobit_header_drop_menu_hover_color' ) != '#ff4800' ? ecobit_opt('ecobit_header_drop_menu_hover_color') : $themeColor;
		$headerBtnBgColor         = ecobit_opt( 'ecobit_booking_btn_bg_color' ) != '#ff4800' ? ecobit_opt('ecobit_booking_btn_bg_color') : $themeColor;

		$footerwbgColor     	  = ecobit_opt('ecobit_footer_bg_color');
		$footerwTextColor   	  = ecobit_opt('ecobit_footer_widget_text_color') != '#888888' ? ecobit_opt('ecobit_footer_widget_text_color') : '';
		$widgettitlecolor  		  = ecobit_opt('ecobit_footer_widget_title_color');
		$footerwanchorcolor 	  = ecobit_opt('ecobit_footer_widget_anchor_color') != '#888888' ? ecobit_opt('ecobit_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = ecobit_opt('ecobit_footer_widget_anchor_hover_color') != '#ff4800' ? ecobit_opt('ecobit_footer_widget_anchor_hover_color') : $themeColor;
		
		$footerNewsDefColor    	  = ecobit_opt('ecobit_footer_widget_anchor_color') != '#888888' ? ecobit_opt('ecobit_footer_widget_anchor_color') : $themeColor;

		$fofbg					  = ecobit_opt('ecobit_fof_bg_color');
		$foftonecolor			  = ecobit_opt('ecobit_fof_textone_color');
		$fofttwocolor			  = ecobit_opt('ecobit_fof_texttwo_color');
		...
		$customcss ="
			...
			.footer-area .single_footer_part p, .footer-area .single_footer_part p span, .footer-area .widget_ecobit_newsletter .input-group input, .footer-area .copyright_part_text p, .footer-area .footer_2 .social_icon a, .footer_part .work_hours ul li p, .footer_part .work_hours ul li p span, .footer_part .work_hours h5, .footer_part .copyright_text p
			{
				color: {$footerwTextColor}
			}

			.footer_part .single_footer_part.widget_ecobit_newsletter .btn{
				border-left-color: {$footerNewsDefColor}
			}

			.footer_part .single_footer_part.widget_ecobit_newsletter .btn i
			{
				border-color: {$footerNewsDefColor}
			}

			.footer_part .single_footer_part.widget_ecobit_newsletter .btn, .footer_part .single_footer_part.widget_ecobit_newsletter .btn i, .single_sidebar_widget .tagcloud a:hover{
			...
			.footer-area .widget_ecobit_newsletter .input-group .form-control::placeholder {
				color: {$footerwTextColor};
				opacity: 1;
			}
			
			.footer-area .widget_ecobit_newsletter .input-group .form-control:-ms-input-placeholder {
				color: {$footerwTextColor};
			}
			...
			.footer_part .single_footer_part.widget_ecobit_newsletter form .btn
			{
			...
			.footer-area .btn, .footer_part .single_footer_part.widget_ecobit_newsletter form .btn{
    ...
    wp_add_inline_style( 'ecobit-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'ecobit_common_custom_css', 50 );