...
// image default alt
if( !function_exists( 'ecobit_img_default_alt' ) ){
	function ecobit_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'ecobit_img_tag' ) ){
	function ecobit_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = ecobit_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'ecobit_anchor_tag' ) ){
	function ecobit_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'ecobit_heading_tag' ) ){
	function ecobit_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'ecobit_paragraph_tag' ) ){
	function ecobit_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'ecobit_other_tag' ) ){
	function ecobit_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'ecobit_button_element ' ) ){
	function ecobit_button_element( array $args ){
